...
> 
>
> eg：当k为18时，机器人能够进入方格(35,37)，因为3+5+3+7=18。但它不能进入方格(35,38)，因为3+5+3+8=19。请问该机器人能够到达多少个格子。
>
> 
>
> solution：回溯法。
...
> 
>
> eg：在字符串"arabcafr"中，最长的不含重复字符的子字符串时"acfr"，长度为4。
>
> 
>
> solution：**动态规划**
